package com.example.o0orick.camera.wordchat.base;
...
import com.example.o0orick.camera.wordchat.listener.IAdapterView;
...
public abstract class BaseAdapterRV<T> extends RecyclerView.Adapter implements IAdapterView {
    ...
    public void addBeanToEnd(T message) {
        mList.add(message);
        notifyItemInserted(getItemCount());
        String str = String.valueOf(getItemCount());
        Log.d("BaseAdapterRV", str);
