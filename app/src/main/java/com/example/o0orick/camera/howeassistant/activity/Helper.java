package com.example.o0orick.camera.howeassistant.activity;
...
import com.example.o0orick.camera.howeassistant.action.CallAction;
import com.example.o0orick.camera.howeassistant.action.CallView;
import com.example.o0orick.camera.howeassistant.action.MessageView;
import com.example.o0orick.camera.howeassistant.action.OpenAppAction;
import com.example.o0orick.camera.howeassistant.action.OpenQA;
import com.example.o0orick.camera.howeassistant.action.ScheduleCreate;
import com.example.o0orick.camera.howeassistant.action.ScheduleView;
import com.example.o0orick.camera.howeassistant.action.SearchAction;
import com.example.o0orick.camera.howeassistant.action.SearchApp;
import com.example.o0orick.camera.howeassistant.action.SearchWeather;
import com.example.o0orick.camera.howeassistant.action.SendMessage;
import com.example.o0orick.camera.howeassistant.bean.AnswerBean;
import com.example.o0orick.camera.howeassistant.bean.DataBean;
import com.example.o0orick.camera.howeassistant.bean.DatetimeBean;
import com.example.o0orick.camera.howeassistant.bean.MainBean;
import com.example.o0orick.camera.howeassistant.bean.ResultBean;
import com.example.o0orick.camera.howeassistant.bean.SlotsBean;
import com.example.o0orick.camera.howeassistant.util.JsonParser;
...
public class Helper extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化对象
        mSpeechUnderstander = SpeechUnderstander.createUnderstander(Helper.this, mSpeechUdrInitListener);

        mToast = Toast.makeText(Helper.this, "", Toast.LENGTH_SHORT);

        mTts = SpeechSynthesizer.createSynthesizer(Helper.this, mTtsInitListener);
        initLayout();
    }
    ...
    private void initLayout() {
        ...
        findViewById(R.id.start_understander).setOnClickListener(Helper.this);
    }
    ...
    public void help(View view) {
        startActivity(new Intent(Helper.this, HelpActivity.class));
    }
    ...
    public void speakAnswer(String text) {
        // 移动数据分析，收集开始合成事件
        FlowerCollector.onEvent(Helper.this, "tts_play");
            ...
            switch (service) {
                ...
                case "telephone":
                    switch (operation) {
                        case "CALL": {    //1打电话
                            ...
                            //可由多个可选条件确定必要条件
                            CallAction callAction = new CallAction(slotsBean.getName(), slotsBean.getCode(), Helper.this);//目前可根据名字或电话号码拨打电话
                            callAction.start();
                            break;
                        }
                        case "VIEW": {    //2查看电话拨打记录
                ...
                case "message": {//2 短信相关服务
                    ...
                    switch (operation) {
                        ...
                        case "SEND": {//1发送短信
                            SendMessage sendMessage = new SendMessage(slotsBean.getName(), slotsBean.getCode(), slotsBean.getContent(), Helper.this);
                            sendMessage.start();
                            break;
                        }
                ...
                case "app": {//3 应用相关服务
                    ...
                    switch (operation) {
                        ...
                        case "LAUNCH": {//1打开应用
                            OpenAppAction openApp = new OpenAppAction(slotsBean.getName(), Helper.this);
                            openApp.start();
                            break;
                        }
                ...
                case "websearch": {//5 搜索相关服务
                    ...
                    switch (operation) {
                        ...
                        case "QUERY": {//1搜索
                            ...
                            SearchAction searchAction = new SearchAction(slotsBean.getKeywords(), Helper.this);
                            searchAction.Search();
                            break;
                        }
    ...
    protected void onResume() {
        //移动数据统计分析
        FlowerCollector.onResume(Helper.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(Helper.this);
        super.onPause();
    }
